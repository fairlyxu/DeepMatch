...
def get_youtube_recall_res(user_embs_dict, doc_embs_dict, user_idx_2_rawid, doc_idx_2_rawid, topk=10):
    """近邻检索，这里用annoy tree"""
    # 把doc_embs构建成索引树
    f = user_embs_dict.size()
    t = AnnoyIndex(f, 'angular')
    for i, v in enumerate(doc_embs_dict.keys):
        t.add_item(i, v)
    t.build(10)
...
if __name__ == "__main__":
    ...
    user_recall_items_dict = get_youtube_recall_res(user_embs_dict, item_embs_dict,topk=10)
